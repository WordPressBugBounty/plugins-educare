...
*
* Contributors: fixbd
* GitHub link: https://github.com/fixbd/clone-field/assets/clone-field.js
		...
		***************************************************************************/
		...
		$(s.addButton).click(function () {
			...
			if (counter < s.maxField) {
				...
				counter++;
				//Add field html
				$(s.cloneBody).append('<tr class="cloneField"><td><input type="number" name="rules1[]" value="" placeholder="Less Mark"/></td><td><input type="number" name="rules2[]" value="" placeholder="Greater Mark"/></td><td><input class="" type="number" name="point[]" value="" placeholder="Grade point"/></td><td><input class="bold" type="text" name="grade[]" value="" placeholder="Grade"/></td><td><input type="text" value="" placeholder="Unlock Premium" disabled/></td><td><a href="javascript:void(0);" class="remove_button"><i class="dashicons dashicons-no"></i></a></td></tr>');
